...
public class WordCountPojo {
	...
	public static class Word {
		...
		// *********************************************************
		// 如果没有默认的构造方法，会抛出异常：InvalidProgramException
		// Word is missing a default constructor so it cannot be used as a POJO type and must be processed as GenericType.
		// Please read the Flink documentation on "Data Types & Serialization" for details of the effect on performance.
		// See. https://ci.apache.org/projects/flink/flink-docs-release-1.9/dev/types_serialization.html#rules-for-pojo-types
		// *********************************************************
