...
public class AssignWatermark {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 第二个字段是时间戳
        DataStream<Tuple2<String, Long>> watermark = input.assignTimestampsAndWatermarks(WatermarkStrategy
    ...
    public static class MyPeriodicGenerator implements WatermarkGenerator<Tuple2<String, Long>> {
        ...
        public void onPeriodicEmit(WatermarkOutput output) {
            // Watermark 比 currentMaxTimestamp 最大值慢1分钟
