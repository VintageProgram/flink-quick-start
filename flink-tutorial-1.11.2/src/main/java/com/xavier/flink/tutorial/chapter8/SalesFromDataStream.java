...
//        env.execute("table api");
        ...
        Table itemSalesTable = tEnv.fromDataStream(
                ...
                // processing-time named 'ts'
                $("ts").proctime()
        );

        // 此时表还没有注册到 catalog 中
        System.out.println("tables: " + Arrays.toString(tEnv.listTables()));
        System.out.println("temporary tables: " + Arrays.toString(tEnv.listTemporaryTables()));
